'''
Author: your name
Date: 2020-11-26 15:19:34
LastEditTime: 2020-11-26 15:53:06
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: \PythonStudent\Python_Test\Tool_Test\Data_storage.py
'''
import xlrd
import pymysql
#打开数据所在的工作簿，以及选择存有数据的工作表
book = xlrd.open_workbook(r"C:\Users\NICK 豪\Desktop\students.xlsx")
